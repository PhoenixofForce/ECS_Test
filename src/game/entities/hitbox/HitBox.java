...
public class HitBox {
	 ...
	 */
	public double collisionDepth(HitBox box2, double ax, double ay) {
	 ...
	 * @return the distance
	 */
	public double distance(HitBox hitBox2) {
		return Math.sqrt(Math.pow(hitBox2.getCenterX() - getCenterX(), 2) + Math.pow(hitBox2.getCenterY() - getCenterY(), 2));
	}
